                    ...
                    >
                      <a className="flex py-3 items-center cursor-pointer">
                        <article className="relative w-6 h-6 object-contain">
                          ...
                          <span
                            className={`${
                              imageError[school.id] ? "hidden" : "flex"
                            }`}
                          >
                            <Image
                              src={
                          ...
                          {!imageError[school.id] ? null : (
                            <span
                              className={`${
                                !imageError ? "hidden" : "flex"
                              } items-center justify-center min-w-full min-h-full bg-[#fff] rounded-full object-cover border-white`}
                              style={{
                                color:
                                  colors[
