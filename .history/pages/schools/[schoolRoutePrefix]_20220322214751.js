  ...
  return (
    <>
      <SEO
        ...
        keywords={`Best school in ${state}, Best school in ${countries.map(
          (country) => {
            return country.name;
          }
        )}, Best school in ${city},
Best schools in ${state}, Best schools in ${countries.map((country) => {
          return country.name;
        })}, Best schools in ${city}, Schools in ${state}, Schools in ${countries.map(
          (country) => {
            return country.name;
          }
        )}, Schools in ${city}, School in ${state}, School in ${countries.map(
          (country) => {
            return country.name;
          }
        )}, School in ${city}, private schools in ${city}, private schools in ${states.map(
          (state) => {
            return state.name;
          }
        )}, private schools in ${countries.map((country) => {
          return country.name;
        })},  Best private schools in ${city}, Best private schools in ${states.map(
          (state) => {
            return state.name;
          }
