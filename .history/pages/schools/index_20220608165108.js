...
`}
      ...
      >
        ...
        <div className="w-full h-full flex justify-between relative  ">
          <div className="bg-white fixed bg-black left-0 h-full w-[350px] border-r hidden md2:flex">
            <Sidebar
          ...
          <div
            className={`bg-red-500 relative inset-0 mb-14 mx-auto h-auto w-full  mt-5 max-w-[1000px]  md:pl-6`}
          >
            <Hero1
...
export const getServerSideProps = async () => {
  ...
  const { data, error, loading } = await apolloClient.query({
    query: GET_SCHOOLS,
    variables: { afterId: "", limit: 200, filter: "" },
  });
