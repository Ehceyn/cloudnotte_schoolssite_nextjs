...
function Home({ data }) {
  ...
  const [displayRegisterSchoolPage, setDisplayRegisterSchoolPage] =
    useState(false);
  ...
  return (
    <div>
      <SEO title="Schools" siteTitle="Cloudnotte Schools" />
        ...
        <div className="w-full h-full flex justify-between relative  ">
          <div className="bg-white fixed  left-0 h-full w-1/4 border-r hidden md2:flex">
            <Sidebar
              ...
              onDisplayRegisterSchoolPage={() =>
                setDisplayRegisterSchoolPage(true)
              }
          ...
          <div
            className={`bg-white ${
              displayRegisterSchoolPage ? "hidden" : null
            } relative inset-0 my-0 mx-auto h-auto w-full md:w-3/4 md2:w-1/2 mt-5 md:px-6`}
          >
            <Hero1
          ...
          {/* Displays Conditionally i.e when displayRegisterSchoolPage is true */}
