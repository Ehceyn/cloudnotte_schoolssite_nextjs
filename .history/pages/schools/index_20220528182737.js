...
`}
      ...
      >
        ...
        <div className="w-full h-full flex justify-between relative  ">
          <div className="bg-white fixed bg-black left-0 h-full w-1/4 mr-[350px] border-r hidden md2:flex">
            <Sidebar
          ...
          <div
            className={`bg-white relative inset-0 mb-14 mx-auto h-auto w-full  mt-5  md:px-6`}
          >
            <Hero1
