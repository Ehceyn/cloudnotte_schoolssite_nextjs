      ...
      <section className="w-full flex  flex-col">
        <div className="w-full flex flex-col justify-center items-center mt-4 mb-4">
          <Image
            ...
            height={120}
            src={
              data.getAdmissionApplicant.studentDetails.passportUrl !== "" &&
              data.getAdmissionApplicant.studentDetails.passportUrl.includes(
                "http"
              ) === true
                ? data.getAdmissionApplicant.studentDetails.passportUrl
          ...
          <p className="font-bold text-base mt-2">
            {data.getAdmissionApplicant.studentDetails.firstName}{" "}
            {data.getAdmissionApplicant.studentDetails.lastName}
          </p>
          <p className="font-normal text-base">
            {data.getAdmissionApplicant.studentDetails.gender}
          </p>
        </div>
        <hr />
      </section>
