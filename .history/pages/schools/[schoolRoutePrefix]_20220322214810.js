...
Best schools in ${state}, Best schools in ${countries.map((country) => {
          return country.name;
        })}, Best schools in ${city}, Schools in ${state}, Schools in ${country}, Schools in ${city}, School in ${state}, School in ${country}, School in ${city}, private schools in ${city}, private schools in ${states.map(
          (state) => {
            return state.name;
          }
