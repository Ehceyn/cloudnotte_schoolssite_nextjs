                ...
                <div key={smartSchool.id}>
                  ...
                  >
                    <div className=" w-full my-3 h-fit items-start bg-white flex cursor-pointer">
                      <article className=" mr-3 h-[65px] w-[65px] min-h-[65px] min-w-[65px] object-contain rounded-full">
                        {" "}
                        <span
                          className={`${
                        ...
                        >
                          <Image
                            ...
                            height={70}
                            objectFit="cover"
                            className={` w-[65px] h-[65px] border-gray bg-gray-400 rounded-full`}
                          />
                        </span>
                        <span
                          className={`${
                            imageLoaded ? "hidden" : "flex"
                          } items-center justify-center bg-[#5f9af2] w-[65px] h-[65px]  border rounded-full`}
                        >
