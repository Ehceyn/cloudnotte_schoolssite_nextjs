                ...
                <div key={smartSchool.id}>
                  ...
                  >
                    <div className=" w-full my-3 h-fit items-start bg-white flex cursor-pointer">
                      <article className="mr-3 h-[70px] w-[70px] max-h-[70px] max-w-[70px] object-contain">
                        <span
                          className={`${
                            imageLoaded[index] ? "hidden" : "flex"
                          }`}
                        >
                          <Image
                            src={
                            ...
                            height={70}
                            objectFit="cover"
                            className="bg-gray-300 h-[70px] w-[70px] "
                          />
                        </span>
                        <span
                          className={`${
                            imageLoaded[index] ? "flex" : "hidden"
                          }`}
                        >
                          <Image
                            src={
