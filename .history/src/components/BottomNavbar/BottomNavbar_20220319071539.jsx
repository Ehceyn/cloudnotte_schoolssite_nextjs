...
function BottomNavbar(props) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="  flex flex-col mr-2  w-12 sm:w-fit items-center justify-center cursor-pointer "
        ...
        <div
          className=" w-16 sm:w-fit items-center "
        ...
        <div
          className=" flex flex-col mr-2  w-16 sm:w-fit items-center justify-center cursor-pointer"
        ...
        <div
          className="  w-12 sm:w-fit items-center"
