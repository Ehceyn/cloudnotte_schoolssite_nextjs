...
function BottomNavbar(props) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="  flex flex-col mr-2 overflow-hidden w-9 sm:w-fit items-center truncate justify-center cursor-pointer "
        ...
        <div
          className=" overflow-hidden truncate w-9 sm:w-fit items-center"
