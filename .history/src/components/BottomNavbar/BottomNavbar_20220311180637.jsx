  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="  flex flex-col mr-2 overflow-hidden w-12 sm:w-fit sm:items-center truncate justify-center cursor-pointer "
          onClick={props.onDisplayHomePage}
        >
          <svg
      ...
      >
        ...
        <div className="w-full ">
          ...
          <div className="flex justify-center my-5">
            ...
            <button
              className="bg-[#5F9AF2] hover:brightness-90 text-white font-bold py-2 px-4 rounded-full"
              onClick={props.onDisplayRegisterSchoolPage}
            >
