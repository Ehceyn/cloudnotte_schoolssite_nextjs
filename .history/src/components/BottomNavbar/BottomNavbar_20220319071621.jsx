...
function BottomNavbar(props) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="  flex flex-col mr-2  w-12 sm:w-fit items-center truncate justify-center cursor-pointer "
        ...
        <div
          className=" truncate w-16 sm:w-fit items-center "
        ...
        <div
          className=" flex flex-col mr-2  w-16 sm:w-fit items-center truncate justify-center cursor-pointer"
        ...
        <div
          className="  truncate w-12 sm:w-fit items-center"
