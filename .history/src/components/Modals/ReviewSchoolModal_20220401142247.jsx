        ...
        <div className="flex justify-center items-center mb-4">
          <article className="relative">
            ...
            <input
              type="text"
              id="reviewerName"
              className="shadow-sm h-12 pl-12 border border-[#CFDBEA] text-base text-gray-900 rounded-[5px] outline-none focus:ring-[#5f9af2] focus:border-[#5f9af2] block w-[260px]  xs:w-[320px] p-2.5 bg-[#F8FBFF]"
              placeholder="Name"
              required
            />
          </article>
