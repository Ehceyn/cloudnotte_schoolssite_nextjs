...
function ChangeLocationModal(props) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="h-[100vh] w-[100vw] md:h-[70vh] md:min-w-[70vw] md:w-[70vw] mx-auto md:border md:overflow-scroll md:rounded-2xl bg-white px-6 py-6 transition-all duration-300"
