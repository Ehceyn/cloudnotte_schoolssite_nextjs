      ...
      >
        ...
        <form className="w-[260px]  xs:w-[320px] flex rounded-[5px] ">
          <textarea
            ...
            id="review"
            name="review"
            className="shadow-sm border py-5 px-4 mb-6 border-[#CFDBEA] text-gray-900 text-sm rounded-[5px] outline-none focus:ring-[#5f9af2] focus:border-[#5f9af2] block w-full p-2.5 bg-[#ff]   "
