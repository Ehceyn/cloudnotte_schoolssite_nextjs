...
function MessageModal(props) {
  ...
  return (
    <section
      className={`w-full h-screen bg-[#00000065] fixed overflow-hidden scrollbar-hide inset-0 z-30 flex items-center  justify-center ${
          ...
          onClick={() => {
            if (props.status === "success") {
              props.showBtn
                ...
                : props.onCallDisplayMessageModal();
            } else {
              props.onCallDisplayMessageModal();
            }
          }}
