  ...
  return (
    ...
    >
      ...
      >
        ...
        <form className="w-[260px]  xs:w-[320px] flex border rounded-[5px] py-5 px-4 mb-6">
          <textarea
            type="text"
            id="review"
            name="review"
            className="shadow-sm pl-7 border  text-gray-900 text-sm rounded-[5px] outline-none focus:ring-[#5f9af2] focus:border-[#5f9af2] block w-full p-2.5 bg-[#F8FBFF]   "
