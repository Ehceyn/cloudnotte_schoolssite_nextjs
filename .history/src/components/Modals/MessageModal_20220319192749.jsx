...
function MessageModal(props) {
  return (
    ...
    >
      <div
        className="w-[400px] h-[400px] border rounded-2xl bg-white px-6 py-6 flex flex-col justify-center items-center"
      ...
      >
        ...
        <h1 className={`text-2xl font-base text-center sm:text-left `}>
          {props.status === "success"
        ...
        <p>
          {props.status === "success"
            ? "Please Check your email for your application details"
