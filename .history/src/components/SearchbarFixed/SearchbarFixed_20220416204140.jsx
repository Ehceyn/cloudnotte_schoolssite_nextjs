...
function SearchbarFixed(props) {
  ...
  return (
    <section className="">
      <div
        className={`fixed z-20 top-0 left-0 right-0 flex items-center flex-col justify-center transition-all duration-500 mt-0  w-full py-1 sm:py-5 px-auto border-b bg-[#F8FBFF] ${
      ...
      >
        <label className="relative  rounded w-11/12 sm:w-3/5 ">
          ...
          <input
            className="placeholder:text-slate-400 flex bg-white w-full border border-slate-300 focus:rounded-t-3xl focus:rounded-b-none rounded-full py-1 pl-9 pr-3 shadow-sm focus:outline-none focus:border-[#F5F6F7] focus:ring-[#F5F6F7] focus:ring-1 sm:text-sm"
