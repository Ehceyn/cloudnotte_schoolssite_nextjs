...
function SearchbarFixed(props) {
  ...
  return (
    <section className="">
      <div
        className={`fixed z-20 top-0 left-0 right-0 container flex items-center flex-col justify-center transition-all duration-500 mt-0  w-full py-3 sm:py-5 border-b bg-[#F8FBFF] ${
