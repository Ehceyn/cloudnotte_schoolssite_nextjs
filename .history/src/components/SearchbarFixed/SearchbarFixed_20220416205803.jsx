...
function SearchbarFixed(props) {
  ...
  return (
    <section className="">
      <div
        className={`fixed z-20 mx-3  top-0 left-0 right-0 flex items-center justify-center transition-all duration-500 mt-0  w-full py-2 sm:py-5 px-auto border-b bg-[#F8FBFF] ${
