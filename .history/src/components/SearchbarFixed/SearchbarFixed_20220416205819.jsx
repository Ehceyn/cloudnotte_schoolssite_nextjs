...
function SearchbarFixed(props) {
  ...
  return (
    <section className="">
      <div
        className={`fixed z-20 px-3  top-0 left-0 right-0 flex items-center justify-center transition-all duration-500 mt-0  w-full py-2 sm:py-5 px-auto border-b bg-[#F8FBFF] ${
          props.display === false ? "hidden" : "flex"
        } ${show ? "null" : " -translate-y-full"}`}
      >
        <label className="relative  rounded flex grow ml-2">
