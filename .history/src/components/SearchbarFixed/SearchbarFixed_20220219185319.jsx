...
function SearchbarFixed(props) {
  ...
  return (
    <section className="">
      ...
      >
        <label class="relative block w-11/12 sm:w-3/4 ">
          <span class="absolute inset-y-0 left-0 flex items-center pl-2">
            <img src={search_icon} className="w-5 h-5 " alt="" />
          </span>
          <input
            class="placeholder:text-slate-400 flex bg-white w-full border border-slate-300 rounded-full py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-[#F5F6F7] focus:ring-[#F5F6F7] focus:ring-1 sm:text-sm"
