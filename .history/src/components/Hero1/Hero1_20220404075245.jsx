...
function Hero_1(props) {
  ...
  return (
    <>
      <section
        className={`${styles.hero_1_bg} mx-3 h-[500px] xs:h-[150px] xs:mx-6 md:mx-0 flex items-center flex-col  justify-center rounded-lg mb-4 bg-gray-300`}
      >
                          ...
                          {imageLoaded ? null : (
                            ...
                            >
                              {school.name.split(" ").map((word, index) => {
                                return (
                                  <span
                                    className=" text-bold text-white text-xs"
                                    key={index}
                                  >
                                    {index <= 1
