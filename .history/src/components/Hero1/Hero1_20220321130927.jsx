      ...
      >
        <div className="container flex items-center flex-col justify-center w-full  rounded ">
          <label className="relative block ">
            ...
            <input
              className={`placeholder:text-slate-400 flex shrink bg-white w-[80vw] sm:w-[70vw] md:w-[40vw] border border-slate-300 focus:ring-[transparent] ${
                input.searchInputs !== "" &&
                "focus:rounded-t-3xl focus:rounded-b-none"
              } rounded-full  py-2 pl-9 pr-3 shadow-sm focus:outline-none sm:text-sm`}
