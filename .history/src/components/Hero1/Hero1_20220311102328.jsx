      ...
      >
        <div className="container flex items-center flex-col justify-center w-full  rounded ">
          <label className="relative block ">
            ...
            <input
              className="placeholder:text-slate-400 flex shrink bg-white w-[80vw] sm:w-[70vw] md:w-[40vw] border border-slate-300 rounded-t-3xl rounded-b-none py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-[#2b6cb0] focus:ring-[#2b6cb0] focus:ring-1 sm:text-sm"
              placeholder="Search a school (Enter a keyword)"
              type="text"
              name="search"
            />
            <div className="absolute z-30 inset-x-0 top-[38px] w-[inherit] h-14 px-14 bg-white rounded-b-3xl">
              <article className="flex">
                <Image
                  ...
                  alt=""
                />
                <p>Learners international school</p>
              </article>
            </div>
          </label>
        </div>
