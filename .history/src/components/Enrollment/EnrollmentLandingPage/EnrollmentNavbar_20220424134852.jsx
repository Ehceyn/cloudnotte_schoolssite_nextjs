    ...
    <>
      <div className="bg-[#5f9af2] text-[#E7F0FB] h-10 sm:h-20 w-full flex items-center px-3 md:px-10 md2:px-28 md3:px-40">
        <article className="flex w-full justify-between sm:justify-start">
          <p
            className={`text-[#E7F0FB] hidden font-medium mr-2 sm:mr-7 cursor-pointer text-[0.75em] sm:text-base ${
          ...
          <p
            className={`text-[#E7F0FB] font-medium mr-2 sm:mr-7 cursor-pointer text-[0.75em] sm:text-base ${
