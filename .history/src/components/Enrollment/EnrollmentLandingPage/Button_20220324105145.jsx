...
export function Button2(props) {
  return (
    <button
      type="submit"
      className={`${styles.enrollment_landing_btn_2} ${props.customStyle} flex justify-center items-center border font-medium ${props.py} ${props.px} ${props.bg} ${props.color} ${props.hoverBg} capitalize hover:brightness-90`}
    >
      {props.children}
    </button>
  );
