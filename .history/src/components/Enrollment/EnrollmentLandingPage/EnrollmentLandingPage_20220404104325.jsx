      ...
      <div className="px-5 md:px-10 md2:px-28 md3:px-40 mt-6 sm:mt-14 mb-5">
        <div className="flex justify-between mb-5 sm:mb-0 h-fit items-start">
          <div className="flex items-center ">
            <article className="flex items-center justify-center w-[70px] h-[70px] sm:w-[170px] sm:h-[170px] object-contain bg-white rounded-full sm:border border-gray-300 relative">
              <span
                title="Tech School"
