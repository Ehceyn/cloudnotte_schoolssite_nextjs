...
function EnrollmentAcademicDetails({
  ...
  const [displayMessageModal, setDisplayMessageModal] = useState();
      ...
      <div className="w-full bg-white">
        ...
        <form
          ...
          onSubmit={(e) => {
            ...
            formik.isValid && uploadMessage !== {} && fee <= 0
        ...
        >
          <MessageModal
            ...
            onCallDisplayMessageModal={!displayMessageModal}
          />
              ...
              <div className="flex flex-col items-center w-full">
                ...
                <div className=" w-full bg-[#F8FBFF] px-10 py-14">
                  {allDocs?.map((doc, index) => {
                    ...
                    return (
                      <div className="mb-6 w-full " key={doc.name}>
