...
function EnrollmentAcademicDetails({ onEnroll }) {
  ...
  console.log(myForm.current, "Obbbbu");
  ...
  const formItems = document.querySelector("#academicDetailsForm")
    .firstElementChild.nextElementSibling.firstElementChild.nextElementSibling
    .children;
  console.log(formItems, "fooooo");
  const formItemsArray = [...formItems];
  formItemsArray.forEach((item) => {
    console.log(item, "Oby");
  });
