  ...
  return (
    ...
    >
      <p>
        ...
        <span className="text-[700] text-[#8ea2ba] ">{name}</span> admission
        enrollment system for 2021/2022 Academic session. Available
        Class/Programmes are:{" "}
        <span className="text-[700] text-[#8ea2ba] ">
      ...
      <p>
        ...
        <span className="text-[700] text-[#8ea2ba] ">{email}</span>,{" "}
        <span className="text-[700] text-[#8ea2ba] ">{phoneNumber}</span> if you
