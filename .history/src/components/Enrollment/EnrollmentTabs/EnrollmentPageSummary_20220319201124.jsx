  ...
  return (
    ...
    >
      <p>
        ...
        <span className="text-bold">{name}</span> admission enrollment system
        for 2021/2022 Academic session. Available Class/Programmes are:{" "}
      ...
      <p>
        ...
        <span className="text-bold">{phoneNumber}</span> if you need more
        information to continue with the application process. <br />
