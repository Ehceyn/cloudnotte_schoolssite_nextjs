      ...
      <div className="w-full bg-white">
        ...
        >
          <div className="flex flex-col items-center justify-center sm:justify-start mr-0 mt-5 sm:mr-10 sm:mt-7  w-full  sm:w-[200px] mb-7 sm:mb-0">
            <label
              htmlFor="Passport"
              className={`relative after:bg-[#00000071] after:absolute after:inset-0 after:rounded-full after:w-full after:h-full after:z-10 after:flex after:items-center after:justify-center after:cursor-pointer`}
            >
              {image.preview ? (
                <Image
                  width={100}
