  ...
  return (
    ...
    >
      <p>
        ...
        <span className="text-bold text-[#E7F0FB] ">{name}</span> admission
        enrollment system for 2021/2022 Academic session. Available
        Class/Programmes are:{" "}
        <span className="text-bold text-[#E7F0FB] ">
      ...
      <p>
        ...
        <span className="text-bold text-[#E7F0FB] ">{email}</span>,{" "}
        <span className="text-bold text-[#E7F0FB] ">{phoneNumber}</span> if you
