...
function EnrollmentPageSummary() {
  return (
    <div className="px-5 md:px-10 md2:px-28 md3:px-40 text-justify w-full xs:w-[85%] sm:w-[70%] mt-10 mb-14 mx-auto text-[0.8em] sm:text-base">
      <p>
      ...
      <article className="flex w-full py-14 justify-center">
        <div className="flex flex-col sm:flex-row">
          <Button
            customStyle="enrollment_landing_btn_2 sm:w-[230px] border sm:border-0"
          ...
          <Button
            customStyle="enrollment_landing_btn_3 border"
            py="py-2"
