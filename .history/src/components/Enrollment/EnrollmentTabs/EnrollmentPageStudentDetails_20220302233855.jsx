import React, { useEffect, usestd_State } from "react";
import { useFormik } from "formik";
import Image from "next/image";
import { Button2 } from "../EnrollmentLandingPage/Button";
import { useEnrollmentTabsValue } from "../../../std_StateProviders/EnrollmentTabsProvider";
import { useFormDetailsstd_StateValue } from "../../../std_StateProviders/FormDetailsProvider";

function EnrollmentPageStudentDetails() {
  const [tab, dispatch] = useEnrollmentTabsValue();

  const [formDetailsStore, formDetailsDispatch] =
    useFormDetailsstd_StateValue();

  // DISPATCH ENROLLMENT TAB std_STATE
  const changeTab = (id) => {
    console.log("tab: " + id);
    dispatch({
