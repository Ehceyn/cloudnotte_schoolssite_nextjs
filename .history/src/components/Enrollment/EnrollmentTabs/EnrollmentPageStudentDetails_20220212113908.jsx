...
import Button from "../EnrollmentLandingPage/Button";
      ...
      <div className="w-full bg-white">
        ...
        <form className="flex flex-col sm:flex-row w-full">
          ...
          <div className="w-full">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between">
              <div class="mb-6 w-full sm:w-1/2 mr-0 sm:mr-10">
                <input
                  type="text"
                  id="Lname"
                  class="shadow-sm h-12 pl-7 border border-[#CFDBEA] text-gray-900 text-sm rounded-[5px] outline-none focus:ring-[#5f9af2] focus:border-[#5f9af2] block w-full p-2.5 bg-[#F8FBFF]   "
            ...
            <div className="w-full flex justify-end">
              <Button
                customStyle="enrollment_landing_btn_2 w-full sm:w-[250px]"
                py="py-3"
