...
function EnrollmentPageSummary({ display, name, admissionProgrammes }) {
  ...
  return (
    ...
    >
      <p>
        Welcome to the first stage of the {name} admission enrollment system for
        2021/2022 Academic session. Availabe Class/Programmes are:{" "}
        {admissionProgrammes?.map((programme, index) => {
          return <span key={index}>{programme.name}</span>;
        })}
        , Please complete the requested information to submit form. Upon
        submitting this information, an account will be opened for you and you
        will be able to begin the application process.
      </p>
      <br />
      <p>
        ...
        applied before. Please contact us at royalcollege@gmail.com if you need
        more information to continue with the application process.
      </p>
