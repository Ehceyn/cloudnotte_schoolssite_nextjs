  ...
  return (
    ...
    (
      <div className="w-full flex flex-col justify-center items-center mt-7 mb-10">
        <article className="w-[60px] h-[60px] sm:w-[150px]  sm:h-[150px] object-contain rounded-full sm:border border-white">
          <span
            title="Tech School"
        ...
        <span className={`${imageLoaded ? "hidden" : "flex"}`}>
          <Image
            ...
            className="w-[60px] h-[60px] sm:w-[150px]  sm:h-[150px] object-contain sm:border border-white"
            alt={data.school.name}
          />
        </span>
        <h2
