        ...
        >
          <div className="cursor-pointer">
            <div className="flex px-3 xs:px-5 py-5">
              <article className="h-[85px] w-[85px] min-h-[85px] min-w-[85px] object-contain rounded-full">
                <Image
                  loading="lazy"
                  ...
                  height={85}
                  objectFit="cover"
                  className={`hidden w-[85px] h-[85px] border-2 border-gray bg-gray-400 rounded-full`}
                  alt={name}
                />
                <Image
                  loading="lazy"
                  ...
                  } w-[85px] h-[85px] border-2 border-gray bg-gray-400 rounded-full`}
                  alt={name}
                />
              </article>
