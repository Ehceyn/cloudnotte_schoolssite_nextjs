        ...
        >
          <div className="cursor-pointer">
            ...
            <div className=" flex px-4 xs:px-7 pt-2 pb-4 flex-wrap cursor-pointer">
              ...
              >
                Welcome to{" "}
                <span className="capitalize">{name.toLowerCase()}</span>, We are
                a thriving educational community of students whose parents and
                guardians have made a decision for their children/wards to study
