...
function SchoolAdCard({ schools }) {
  ...
  return (
    <>
      {schools.launchesPast.forEach((launch) => {
        console.log(launch);
        <section className=" border mt-8 rounded-0 md:rounded-lg">
          ...
          <Link href="/my_school_page/schoolPage" passHref>
            <div className=" flex px-4 xs:px-7 pt-2 pb-4 flex-wrap cursor-pointer">
              <p className=" w-[100vh]">
                ...
                are not as scary as you think, Cloudnotte virtual laboratory
          ...
          <div className=" flex flex-col px-4 xs:px-7 pt-0 pb-4 flex-wrap w-full justify-between">
            <article className="flex w-full justify-between py-3 xs:py-5">
              ...
              <p className="cursor-pointer text-[14px] xs:text-base">
                5 reviews
              </p>
            </article>
