          ...
          <div className="cursor-pointer">
            <div className="flex px-3 xs:px-5 py-5">
              <article className="h-[85px] w-[85px] relative min-h-[85px] min-w-[85px] object-contain rounded-full">
                <span className="absolute z-[1] top-2 right-1 bg-[#5f9af2] p-1 rounded-full text-white">
                  <GrTechnology fontSize="14px" className="text-white" />
                </span>
                <span className={`${imageLoaded ? null : "hidden"}`}>
                  <Image
                    loading="lazy"
                    onLoad={() => {
                      console.log("loaded");
                ...
                <span className={`${imageLoaded ? "hidden" : null}`}>
                  <Image
                    loading="lazy"
