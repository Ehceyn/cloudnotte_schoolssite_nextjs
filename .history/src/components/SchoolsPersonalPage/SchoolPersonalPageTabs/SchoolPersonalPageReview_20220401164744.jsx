...
function SchoolPersonalPageReview(props, data) {
...
export const getServerSideProps = async (context) => {
  ...
  const schoolId = context.params.schoolRoutePrefix;

  console.log(schoolId, "schoolId");

  const { data, loading, error } = await apolloClient.query({
    query: GET_SCHOOL_REVIEWS,
    variables: { schoolId: schoolId, limit: 100, afterId: "" },
  });
