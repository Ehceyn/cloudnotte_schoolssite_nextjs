...
function SchoolPersonalPageReview({ onCallReviewSchoolModal }) {
  return (
    <article className="py-5 sm:py-9 px-0 xs:px-9 sm:px-12 sm:border-2 leading-8 ">
      <div className="flex justify-between">
        ...
        <p
          className="text-sm font-bold text-[#5F9AF2] pl-2 mb-5 sm:mb-12 capitalize"
          onClick={onCallReviewSchoolModal}
        >
          Submit Review
        </p>
      </div>
