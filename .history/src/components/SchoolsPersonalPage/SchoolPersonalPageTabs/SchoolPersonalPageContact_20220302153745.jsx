...
function SchoolPersonalPageContact() {
  return (
    <article className="py-5 sm:py-14 px-0 xs:px-9 sm:px-12 sm:border-2 leading-8">
      ...
      <hr />
      <div className="pl-4">
        <p className="text-base flex my-3">
          <svg
          ...
          +234 903 5829083, +234 651773 9939
        </p>
        <p className="text-base flex my-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          Hello@infoschool.com, schoolfun@gmail.com
        </p>
        <p className="text-base flex my-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="pl-4">
        <p className="text-base flex my-3">
          ...
          110 East west road Rumuodara Port harcourt , Nigeria
        </p>
      </div>
    </article>
  );
