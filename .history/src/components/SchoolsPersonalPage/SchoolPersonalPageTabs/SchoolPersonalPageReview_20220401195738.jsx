  ...
  return (
    <article className="py-5 sm:py-9 px-0 xs:px-9 sm:px-12 sm:border-2 leading-8 ">
      <div className="flex justify-between">
        <h2 className="text-base font-bold  mb-2 capitalize">Reviews</h2>
        <p
      ...
      {loading && <p>Loading School Reviews...</p>}
      {reviews && reviews.length > 0
                ...
                <article className="flex justify-between items-center mt-2">
                  <div className="flex items-center">
                    <Image
                      width={32}
                      height={32}
                      src="https://res.cloudinary.com/zichygraphs/image/upload/v1648833921/avatar_dsfadx.png"
        ...
        : !loading && <p>There are no reviews for this School</p>}
    </article>
  );
}
