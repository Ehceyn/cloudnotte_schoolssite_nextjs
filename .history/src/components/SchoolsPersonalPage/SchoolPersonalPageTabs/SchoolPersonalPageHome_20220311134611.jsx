  ...
  return (
    <>
      <div className="w-full flex flex-wrap items-center justify-end mb-4">
        ...
        <button
          type="button"
          className="bg-white border border-[#5f9af2] text-[#5f9af2] text-xs hover:brightness-[98%] mr-2 mb-2 sm:mb-0 font-bold py-2 px-1 sm:px-4 rounded-full"
        >
          Admission status
        </button>
        <button
        ...
        <button
          type="button"
          className="bg-white border flex border-[#5f9af2] text-[#5f9af2] text-xs hover:brightness-[98%] mr-2 mb-2 sm:mb-0 font-bold py-2 px-1 sm:px-4 rounded-full"
        >
          Download School App{" "}
        </button>
      </div>
