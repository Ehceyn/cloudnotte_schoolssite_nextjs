            ...
            <div className="flex pl-18 px-5 pt-5">
              <article className=" bg-red-500">
                <Image
                  ...
                  height={100}
                  width={100}
                  className="w-[60px] h-[60px] sm:w-[150px] absolute z-10  sm:h-[150px] object-contain bg-gray-800 rounded-[50%] sm:-translate-y-12 border-white md:border-8 sm:border object-contain"
                  alt=""
                />
              </article>
