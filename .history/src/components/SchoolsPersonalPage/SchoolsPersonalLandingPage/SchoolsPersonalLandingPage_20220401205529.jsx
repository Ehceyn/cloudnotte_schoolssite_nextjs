          ...
          <Slider {...settings}>
            {assetsUrl.length > 0 ? (
              assetsUrl.map((asset, index) => {
                return (
                  <div key={index}>
                    <div className=" shadow-sm shadow-[#63f7f044] rounded-b-[5px] bg-gray-300 flex justify-center border-bl-[5px] border-br-[5px] object-fill h-[200px] xs:h-[300px] sm:h-[350px] md:h-[400px] ">
                      <img
                        src={
                          asset
                            ? asset
