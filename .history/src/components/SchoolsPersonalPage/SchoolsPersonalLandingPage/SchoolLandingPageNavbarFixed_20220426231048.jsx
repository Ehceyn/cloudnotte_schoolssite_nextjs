...
function SchoolLandingPageNavbarFixed(props) {
  ...
  return (
    <section className="">
      <div
        className={`fixed z-20 top-0 left-0 right-0 transition-all duration-150 mt-0 items-center justify-center w-full py-2 sm:py-4 px-auto border-b bg-[#F8FBFF] ${
      ...
      >
        <div className="flex w-full justify-between items-center px-5 py-3 xs:py-6 md3:py-0">
          <article className="capitalize flex w-full sm:w-fit justify-between">
            ...
            <p
              className={`text-base font-normal cursor-pointer mr-2 sm:mr-6 ${
                tab === 3 ? "font-[700]" : "font-normal"
              }`}
              onClick={() => {
                changeTab(3);
              }}
