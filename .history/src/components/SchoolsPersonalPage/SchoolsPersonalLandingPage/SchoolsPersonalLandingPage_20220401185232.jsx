          ...
          <Slider {...settings}>
            {assetsUrl.length > 0 ? (
              assetsUrl.map((asset, index) => {
                return (
                  <div key={index}>
                    <div className=" shadow-sm shadow-[#63f7f044] bg-gray-300 flex justify-center border-bl-[5px] border-br-[5px] object-contain">
                      <img
                        src={
                          asset
                            ? asset
                        ...
                        className="w-[800px] h-[200px] xs:h-[300px] sm:h-[350px] md:h-[400px]  sm:rounded-br-md sm:rounded-bl-lg object-cover"
                        alt={name + " " + asset}
                      />
                    </div>
                  </div>
              ...
              <div>
                <div className=" shadow-sm shadow-[#63f7f044] bg-gray-300 flex justify-center border-bl-[5px] border-br-[5px] object-contain h-[200px] xs:h-[300px] sm:h-[350px] md:h-[400px] ">
                  <img
                    src={`https://res.cloudinary.com/zichygraphs/image/upload/v1648834278/school-ad-img-1_qkjvwh.png`}
                    className="w-[800px]  sm:rounded-br-md sm:rounded-bl-lg object-cover"
                    alt="No asset"
                  />
                </div>
              </div>
