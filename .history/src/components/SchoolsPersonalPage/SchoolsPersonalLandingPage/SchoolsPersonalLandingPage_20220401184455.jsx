        ...
        <div>
          <Slider {...settings}>
            {assetsUrl.length > 0 ? (
                  ...
                  <div key={index}>
                    <div className=" shadow-sm shadow-[#63f7f044] bg-gray-300 flex justify-center border-bl-[5px] border-br-[5px] object-contain">
                      <img
                        ...
                        className="w-[1500px] h-[200px] xs:h-[300px] sm:h-[350px] md:h-[400px]  sm:rounded-br-md sm:rounded-bl-lg object-cover"
                        alt={name + " " + asset}
                      />
                    </div>
                  </div>
              ...
              <div className="shadow-sm shadow-[#63f7f044] bg-gray-300 flex justify-right bg-red-500 border-bl-[5px] border-br-[5px]">
                <div className="w-[700px] object-contain bg-blue-500">
                  <img
