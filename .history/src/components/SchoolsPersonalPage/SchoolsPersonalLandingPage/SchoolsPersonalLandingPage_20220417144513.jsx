        ...
        <div>
                  ...
                  <div key={index}>
                    <div className=" shadow-sm shadow-[#63f7f044] rounded-b-[5px] bg-gray-300 flex justify-center border-bl-[5px] border-br-[5px] object-contain h-[200px] xs:h-[300px] sm:h-[350px] md:h-[400px] ">
                      <img
                        ...
                        className="w-full rounded-br-[5px] rounded-bl-[5px] object-cover aspect-video"
                        alt={name + " " + asset}
                      />
                    </div>
                  </div>
          ...
          <div className="flex justify-between mb-5 sm:mb-0 h-fit items-center ">
            <div className="flex pl-18 px-5 pt-5">
              <article className=" flex items-center justify-center w-[70px] h-[70px] sm:w-[150px]  sm:h-[150px] object-contain bg-white sm:shadow-sm sm:-translate-y-12 border-white md:border-8 sm:border relative rounded-full">
                <span
                  title="Tech School"
                ...
                >
                  <img
                    ...
                    className="object-cover rounded-full w-[70px] h-[70px] sm:w-[150px] sm:h-[150px]"
                    alt={name}
                  />
                </span>
                {imageLoaded ? null : (
