      ...
      <section className=" md2:px-40 h-fit w-full bg-[#F8FBFF]">
        <div>
          <div className="max-h-[800px] relative">
            ...
            className="w-full max-h-[800px] aspect-video"
            alt=""
          /> */}
            ...
            <div className="flex pl-18 px-5 pt-5">
              <article>
                <Image
                  ...
                  className="w-[60px] h-[60px] sm:w-[150px]  sm:h-[150px] object-contain bg-gray-800 rounded-[50%] sm:-translate-y-12 border-white md:border-8 sm:border"
                  alt=""
                />
              </article>
